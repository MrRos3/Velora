...
local function loadRegistry()
    local registry = safeLoadTable(RAW_BASE .. "Songs.lua?velora=0.8.8")
...
API.Changed:Connect(function(reason)
    ...
    elseif reason=="selection" then
        ...
        task.delay(.15,function() if art.Parent then animate(art,{Rotation=0}) end end)
    end
