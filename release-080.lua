...
local function loadRegistry()
    local registry = safeLoadTable(RAW_BASE .. "Songs.lua?velora=0.8.0")
...
refreshList=function()
    ...
    for index,entry in ipairs(state.Registry) do
        if entryMatches(entry) then
            ...
            local selectedRail=radius(make("Frame",{
            ...
            label(card,entry.Name or "Untitled",UDim2.fromOffset(68,10),UDim2.new(1,-112,0,18),Enum.Font.GothamBold,10,P.Text)

            local statusText=selected and "  •  SELECTED" or (playingCurrent and "  •  PLAYING" or "")
            local meta=label(card,(entry.Artist or "Velora").."  •  "..tostring(entry.BPM or 120).." BPM"..statusText,UDim2.fromOffset(68,32),UDim2.new(1,-112,0,14),Enum.Font.Gotham,8,selected and P.Cyan or (playingCurrent and P.Green or P.Sub))
